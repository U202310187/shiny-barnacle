...
$result_carrito = mysqli_query($conexion, $sql_carrito);
...
if (mysqli_num_rows($result_carrito) == 0) {
    ...
    mysqli_query($conexion, $sql_crear_carrito);
...
if (isset($_GET['accion'])) {
    ...
    if ($accion == 'agregar' && isset($_GET['id'])) {
        ...
        mysqli_query($conexion, $sql_nuevo_item);
        ...
        mysqli_query($conexion, $sql_update_producto);
        ...
        mysqli_query($conexion, $sql_desasociar);
        ...
        if ($total > 0) {
            ...
            mysqli_query($conexion, $sql_update_carrito);
...
<head>
    ...
    <title>Carrito de Compras - Crafted</title>
    <!-- Bootstrap CSS -->
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php while ($producto = mysqli_fetch_assoc($result_productos)) { ?>
                                <tr>
                                    <td>
                                        <img src="<?php echo $producto['imagen_url']; ?>" alt="<?php echo $producto['nombre']; ?>" class="producto-img">
                                    </td>
                                    <td>
